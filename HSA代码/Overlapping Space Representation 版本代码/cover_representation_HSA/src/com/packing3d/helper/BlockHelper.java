...
public class BlockHelper {
    ...
    */
    ...
    /**
     * @Author yajiewen
     * @Date 2022-03-25 12-14-37
     * @Description 获取GC块(A Tree Search Algorithm for Solving theContainer Loading Problem)
     * 注意 所有块中,有的块 只要剩余箱子数目满足生成该块,那么该块 会被使用多次
     */

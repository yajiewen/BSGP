...
//        System.out.println("生成初始状态耗时：" + (System.currentTimeMillis() - start));
    ...
    public void generVlossVector(double spaceLength, double spaceWidth, double spaceHigh, Scheme scheme){
        ...
        this.xUsefulVector = BlockSelector.KPAForArrayListTwo((int)spaceLength,lengthList);
        this.yUsefulVector = BlockSelector.KPAForArrayListTwo((int)spaceWidth,widthList);
        this.zUsefulVector = BlockSelector.KPAForArrayListTwo((int)spaceHigh,hightList);
    }

 ...
 * @Description
 * 真正的非完全支撑,可以放在space八个corner
 * 优化资源更新类,使得更加优美 目前效果最好
*/
public class BSG {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    for (Problem problem : problemList) {
                        State state = algorithmBSG(problem,500 * 1000);
...
//        ArrayList<Block> blockList = BlockHelper.generateGeneralCuttingBlocksNotFullySupported(problem,MaxBlocks,MinFillRate);
        ArrayList<Block> blockList = BlockHelper.generateMyGuillotineBlocksNotFullySupported(problem,MaxBlocks,MinFillRate);

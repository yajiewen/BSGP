...
public class Block {
    ...
    public double blockVolum; // 复杂快的体积(指块有效装填的体积)
    ...
    public void initCoordinateAndRangeWithAnchorCorner(Space space){

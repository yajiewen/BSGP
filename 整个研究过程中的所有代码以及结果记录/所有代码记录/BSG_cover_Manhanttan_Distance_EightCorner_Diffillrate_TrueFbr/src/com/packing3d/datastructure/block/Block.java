...
public class Block {
    ...
    */
    public Block(int typeNumberOfBox, int complexLevel, double blockLenght, double blockWidth, double blockHigh, double viableLength, double viableWidth, double blockVolum, int[] neededBoxNumOfEachType){
        // 在构造函数里面分配空间
        // 坐标空间
        eightCoordinate = new double[8][3];
        // x范围空间

...
import com.packing3d.helper.InitHelper;
...
public class State {
    ...
    public int[] xVlossVector;
    public int[] yVlossVector;
    public int[] zVlossVector;
    // greedy score
...
//        System.out.println("生成初始状态耗时：" + (System.currentTimeMillis() - start));
    ...
    public void generVlossVector(double spaceLength, double spaceWidth, double spaceHigh, Scheme scheme){
        ...
        this.xVlossVector = BlockSelector.KPAForArrayListTwo((int)spaceLength,lengthList);
        this.yVlossVector = BlockSelector.KPAForArrayListTwo((int)spaceWidth,widthList);
        this.zVlossVector = BlockSelector.KPAForArrayListTwo((int)spaceHigh,hightList);
    }
    ...
    */
    public static void renewState(State state,Block block,int selectedSpaceIndex){
        // 更新newState
        state.scheme.addPut(new Put(block,state.spaceArrayList.get(selectedSpaceIndex)));
        // 更新资源相关
...
//        double start = System.currentTimeMillis();
        ...
        // 更新newState
        newState.scheme.addPut(new Put(block,stateOld.spaceArrayList.get(selectedSpaceIndex)));
        // 更新资源相关

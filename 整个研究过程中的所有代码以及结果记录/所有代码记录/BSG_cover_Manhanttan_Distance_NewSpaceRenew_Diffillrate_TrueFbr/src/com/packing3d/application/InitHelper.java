...
import com.packing3d.application.Param;
...
public class InitHelper {
    public static String TITLE  = "BSG_Cover_Not_Support_GuillotineBlock_NewManhanttan2_8Corner_30s_removeSimlarState_Diffillrate_ByFbr17" +
            "\n求块与其余相交空间的更新方法更新\n" +
            "使用了删除相似空间 2\n" +
            "加回判断若状态是初始状态后继个数为w的平方"; // 本次运行开头输出内容
    public static int RUN_TIME_SECOND_LIMIT = 30; // 一次搜索的运行时间

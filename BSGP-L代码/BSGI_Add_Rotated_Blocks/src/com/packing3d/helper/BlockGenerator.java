...
public class BlockGenerator {
    ...
    */
    public static ArrayList<Block> simpleBlocks_Zhang(Problem problem){
        ...
        // 旋转后的块按照大小排序
        blockSort(blockList);
        System.out.println("simple blocks zhang 块生成完毕:" + blockList.size() +"块");
        System.out.println("生成时间" + (System.currentTimeMillis() - start) + "ms");
        return blockList;
    }
    ...
    public static Block xCombiningComplexBlock(Block block1, Block block2, Problem problem, double MinFillRate, double MinAreaRate){
        ...
        double blockVolum = block1.boxVolum + block2.boxVolum;
    ...
    */
    ...
    /**
     * @Author yajiewen
     * @Date 2023-02-16 18-27-10
     * @Description 按照体积从小到大排序
    */
    ...
    public static void deleteSimilarBlock(ArrayList<Block> blockList,double similarScore){
...
//        int num = blockList.size();
        blockList.clear();
        blockList.addAll(returnBlockList);
//        System.out.println("原来" + num + "删除相似后"+ blockList.size());
    }
